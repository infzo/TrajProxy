...
CLAUDE_COMBO_TEST_MODEL_NAME="claude-reasoning-tool-test-model"
CLAUDE_COMBO_TEST_RUN_ID="run-${SCENARIO_ID}"
CLAUDE_COMBO_TEST_SESSION_ID="session-${SCENARIO_ID}-$(date +%s%N | md5sum | head -c 8)"
CLAUDE_COMBO_TEST_TOKENIZER_PATH="Qwen/Qwen3.5-2B-TITO"
CLAUDE_COMBO_TEST_TOOL_PARSER="qwen3_coder"
CLAUDE_COMBO_TEST_REASONING_PARSER="qwen3"
